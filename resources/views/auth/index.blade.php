    ...
    <div class="w-full max-w-md p-8 bg-white/81 backdrop-blur-md rounded-2xl shadow-xl transform transition-all duration-300 fade-in hover-glow hover:scale-105" >
        ...
        <form method="POST" action="/v1/auth" class="space-y-6">
            ...
            <div class="flex items-center justify-between">
                ...
                <a href="" class="text-sm text-blue-400 hover:text-blue-600 transition duration-200 underline-offset-2 hover:underline">Forgot Password?</a>
            </div>
            ...
            <div class="text-center">
                <p class="text-sm text-gray-600">Don't have an account? <a href="{{ route('register') }}" class="text-blue-400 hover:text-blue-600 transition duration-200 underline-offset-2 hover:underline">Register Now</a></p>
            </div>
        </form>
    </div>
