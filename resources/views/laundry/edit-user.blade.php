...
<body class="bg-gradient-to-br from-indigo-900 via-purple-800 to-blue-700 font-poppins flex">
    ...
    <div class="ml-0 md:ml-20 lg:ml-64 p-6 flex-1 transition-all duration-300" id="mainContent">
        ...
        <form method="POST" action="{{ route('update-user', $user->id) }}" class="space-y-6 bg-white/90 backdrop-blur-md rounded-2xl p-8 shadow-xl hover-glow" id="orderForm">
            ...
            <div>
                ...
                <input type="text" id="weight" value="{{ $user->name }}" name="name" min="1" step="0.5" class="w-full mt-2 px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-200 bg-gray-50 text-gray-700 font-poppins" placeholder="Subejo" required>
            </div>
            <div>
                <label for="coin" class="block text-lg font-semibold text-gray-700">Email</label>
                <input type="text" id="coin" value="{{ $user->email }}" name="email" class="w-full mt-2 px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-200 bg-gray-50 text-gray-700 font-poppins" placeholder="contoh@example.com" required>
            </div>
